...
<form name="form1" method="post" action="newOrderM.php" id="form1" >
<fieldset>
...
<br><br>
		...
		?>
    <?$today = date("F j, Y");?>
    <form name="orderform" method="post" action="OrderReportM.php" >


<?
if(isset($_POST["submit1"])){?>

<form name="form2" method="post" action="OrderReportM.php" id="form2"  >
Order ID:  
...
Agent: 
	...
	<td>
		...
		<input required id="price<?= $tr ?>" name="UnitPrice<?= $tr ?>" value="<?= $row[3] ?>" type="integer" size="15">
	</td>
