...
?>
   ...
   <?
   $strSQL4 = "SELECT order_id, status_id, order_date, emp_id FROM salesorder WHERE emp_id=" . $_SESSION["empid"];
...
Edit Order Form</h1>
<form name="form1" method="post" action="editOrderS.php" id="form1">
<fieldset>
...
<form name="form2" method="post" action="EditOrderReportS.php" id="form2" onsubmit= "return form2(this)">
