...
$db = mysqli_connect('database.hosting.vt.edu', 'bit444408', 'qalshathseshzodg', 'bit444408') or die ("I cannot connect to the database because: ".mysqli_connect_error()); 
		...
		$sql = "UPDATE customer SET cust_lname='".$LName."', cust_fname='".$FName."', cust_company='".$cName."', cust_address='".$StreetAddress."', cust_city='".$City."', cust_state='".$State."'
		, region_id='".$rgion."', cust_phone='".$Phone."', cust_fax='".$Fax."', cust_zip='".$zip."', cust_email='".$Email."' WHERE cust_id='".$cID."'";
	...
	<form method="post" action="editcustM.php">
